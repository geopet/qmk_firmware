...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT_ergodox(
      ...
      KC_LSPO,           LCTL_T(KC_Z), KC_X,     KC_C,    KC_V,     KC_B,  KC_HYPR,
      LT(1,KC_GRAVE),    KC_QUOTE,     KC_EQUAL, KC_LEFT, KC_RIGHT,
                                                           KC_LALT, LCTL_T(KC_NO),
                                                           KC_HOME,
                                                           KC_LGUI, KC_BSPACE, KC_END,
      // right hand
      ...
      KC_MEH, KC_N,    KC_M,        KC_COMMA,    KC_DOT,          RCTL_T(KC_SLASH), KC_RSPC,
      KC_UP,  KC_DOWN, KC_LBRACKET, KC_RBRACKET, KC_BSPACE,
